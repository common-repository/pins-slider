<?php
/*
Plugin Name: Pins Slider
Plugin URI: https://wordpress.org/plugins/pins-slider/
Description: Pinterest Slider is awesome tool for your websites. Enjoy the limitless fun with pinterest using our Pinterest Slider.
Version: 1.1
Author: twidgets
...
class RealPinterestSlider{
    ...
    public static function add_real_pin_tools_options_page(){
        ...
        add_options_page('Pins Slider', 'Pinterest Slider ', 'administrator', __FILE__, array('RealPinterestSlider','real_pin_tools_options'));
